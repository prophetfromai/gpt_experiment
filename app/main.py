...
@app.get("/", include_in_schema=False)  # We set 'include_in_schema=False' so this redirection won't appear in the API docs.
async def redirect_to_docs():
    ...
    """
    return RedirectResponse(url="/docs")  # This line does the actual redirecting to the '/docs' page.
